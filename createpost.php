    ...
    <div class="item3">
      <div class="posts-container">
        <div class="card-post" style="width: 80%; height: 80vh">
          <div class="card-left">
            <img src="https://media.sproutsocial.com/uploads/2017/01/Instagram-Post-Ideas.png">
          </div>
          <div class="card-right">
            <form class="content" method="POST" action="process.php">
              <h1 class="mt-3">Create Post <i class="bi bi-pencil-square" id="edit"></i></h1>
              ...
              <div class="row col-11 mb-2 px-3">
                <button type="submit" class="btn mb-2 btn-outline-success float-end" name="new-post">Create post</button>
              </div>
            </form>
          </div>
        </div>
